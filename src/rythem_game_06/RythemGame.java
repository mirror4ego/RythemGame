...
public class RythemGame extends JFrame {
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/OnNOnTitleImage.png")).getImage();
	private Image selectedImage = (new ImageIcon(Main.class.getResource("../images/OnNOnStartImage.jpg"))).getImage();
