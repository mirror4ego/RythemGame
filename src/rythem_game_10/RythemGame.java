...
public class RythemGame extends JFrame {
	...
	public RythemGame() {
		...
		trackList.add(new Track("JoakimKarudTitleImage.png", "JoakimKarudStartImage.jpg", "JoakimKarudGameImage.jpg", "JoakimKarudSelected.mp3", "Rock Angel - Joakim Karud.mp3"));
		trackList.add(new Track("OnNOnTitleImage.png", "OnNOnStartImage.jpg", "OnNOnGameImage.jpg", "OnNOnSelected.mp3", "Cartoon - On n On.mp3"));
		trackList.add(new Track("InspirationTitleImage.png", "InspirationStartImage.jpg", "InspirationGameImage.jpg", "InspirationSelected.mp3", "Unknown Brain - Inspiration.mp3"));
		...
		leftButton.setBounds(140, 310, 48, 48);
		...
		rightButton.setBounds(1080, 310, 48, 48);
	...
	public void screenDraw(Graphics2D g) {
		...
		{			
			...
			g.drawString("Selected Music", 20, 702);
